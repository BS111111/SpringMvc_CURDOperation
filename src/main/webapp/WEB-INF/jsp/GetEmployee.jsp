...
<body>
	...
	<form class="fbox" action="getEmp">
		<h2>Get Employee Record:</h2>
		<label>Id</label> <input type="text" name="id" placeholder="Enter Id">
		<input class="btn" type="submit" value="get Employee">
